...
# case insensitive
local/swbd1_map_words.pl -f 2- $dir/transcripts2.txt  > $dir/text_apo

cat $dir/text_apo | sed "s/'s/ 's/g" | sed "s/- 's/-'s/g"  | sed "s/n't/ n't/g" | sed "s/'ll/ 'll/g" | sed "s/'re/ 're/g" | sed "s/'ve/ 've/g" | sed "s/'m/ 'm/g" | sed "s/'d/ 'd/g" > $dir/text
