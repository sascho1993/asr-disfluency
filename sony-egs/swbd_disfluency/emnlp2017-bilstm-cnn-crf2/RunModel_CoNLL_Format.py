...
elif dataset == "kaldi_test" and experiment == "exp_silver":
    inputColumns = {0:'utt_id', 1:'tokens', 2:'disfluency', 3:'pos'}
elif dataset == "kaldi_test":
    inputColumns = {0: 'utt_id', 1:'tokens', 2:'disfluency', 3:'pos', 4:'word_dur_phone', 5:'word_dur_word', 6:'pause'}
elif dataset == "7_0.0" or dataset == "17_1.0":
    inputColumns = {0: 'utt_id', 1:'tokens', 2:'disfluency', 3:'pos', 4:'word_dur_phone', 5:'word_dur_word', 6:'pause'}
...
if "pitch" in experiment or "energy" in experiment or "formants" in experiment or "prosody" in experiment:
