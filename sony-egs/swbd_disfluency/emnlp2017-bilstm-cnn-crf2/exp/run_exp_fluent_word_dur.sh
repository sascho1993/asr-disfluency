...
#seeds="6571 7013 7039 7333 7577 7687 8191 8423 8707 8933 9661 9739 9907 9973"
...
do
    python3 Train_Disfluencies.py \
        --optimizer adam \
        --dataset disfluency_duration_fluent_only \
        --LSTMSize 200 200 200 200 \
        --seed $seed \
        --dropout 0.25 0.5 \
        --miniBatchSize 32 \
        --expName=$expName \
        --featureNames tokens pos word_dur_phone word_dur_word \
